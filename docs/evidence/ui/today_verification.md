...
- Automated: `npm run check -- ui` → passed=29 failed=0; distinct loading/empty/unavailable, labels, exact money, busy locks, stale versions, typed-input retention, replay receipts, five-second refresh, hidden-tab pause and focus retention.
