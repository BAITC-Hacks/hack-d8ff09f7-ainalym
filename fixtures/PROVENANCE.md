...
`fixtures/documents/iek_invoice_demo_photo.png` — синтетический растровый вариант того же счёта; `replay.json` содержит его SHA-256 и ожидаемое извлечение для демонстрации без ключа модели.
