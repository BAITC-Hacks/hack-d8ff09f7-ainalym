...
events.push({kind:'supplier_reply',org_id,source_id:'SUPPLIER-SE-PARTIAL-DEMO',at:'2026-09-23T09:03:00Z',actor_id:'SE',po_id:'PO-DEMO-SUPPLIER-REPLY',text:'Отгрузим 60 %, остальное через 3 недели.',payload:{supplier_id:'SE',po_id:'PO-DEMO-SUPPLIER-REPLY',affected_lines:['130300027_']}});
