...
export interface Tables {
  ...
  recommendation: { id: string; run_id: string; code_1c: string; supplier_id: string; qty_recommended: number; qty_adjusted: number | null; on_hand: string; in_transit: string; forecast_id: string | null; urgency: string; rationale_ru: string; components: string; state: string; proposal_id: string | null; version: number };
