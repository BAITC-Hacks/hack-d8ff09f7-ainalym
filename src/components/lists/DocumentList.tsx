...
export function DocumentList() {
  ...
  return <div className={styles.page}><header className={styles.header}><div><p className={styles.eyebrow}>ФАЙЛЫ И ЧЕРНОВИКИ</p><h1>Документы</h1><p className={styles.subtitle}>Экспорт заказов и подготовленные материалы по расчётам.</p></div><Button onClick={() => { exports.reload(); drafts.reload(); }}>Обновить</Button></header>
