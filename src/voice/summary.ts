...
export const SPOKEN_SUMMARY_INSTRUCTIONS = "Скажи коротко и структурно: 1) итог одной фразой (сколько и что), 2) три самых важных позиции с количеством и единицей, 3) закончи одним коротким вопросом-предложением с 1–2 следующими шагами по этим данным (например «Подготовить заказ IEK?» или «Показать только просроченное?»). Не читай весь список. Никаких вводных фраз.";
